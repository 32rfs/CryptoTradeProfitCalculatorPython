'''
Student Name: Rafael de Souza Ferreira
Student Number: 3041373
'''
...
class StockTradeProfitCalculator(QDialog):
    ...
    def __init__(self):
        ...
        # the following 2 lines of code are for debugging purposee and show you how to access the
        # self.data to get dates and prices
